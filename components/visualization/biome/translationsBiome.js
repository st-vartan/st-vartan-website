const translations = {
  ...
  fr: {
    categories: [
      ...
      { id: 'vocabulary_ich_945', label: 'Zones arides' }, //"Drylands"
  ...
  es: {
    ...
    intro_subtext:
      'Esta visualización interactiva proporciona información sobre el modo de interconexión con la naturaleza de los elementos del patrimonio cultural vivo inscritos en las Listas de Convención de 2003. Navegue por ella y busque, por ejemplo, términos como “Ríos”, “Árboles”, “Caballos”, etc., a fin de poder ver qué relación guardan con los ocho grandes ecosistemas del mundo. Conozca mejor esta clase de patrimonio e imagine en qué categoría se situaría el suyo propio.',
    intro_info:
